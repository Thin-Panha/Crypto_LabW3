...
import (
	...
	"flag"
	"fmt"
	"lab3-sha512-cracking/utils/crack"
	"os"
	"path/filepath"
	"strings"
	"time"
...
func main() {
	...
	hashValue := flag.String("h", "485f5c36c6f8474f53a3b0e361369ee3e32ee0de2f368b87b847dd23cb284b316bb0f026ada27df76c31ae8fa8696708d14b4d8fa352dbd8a31991b90ca5dd38", "Target SHA512 hash to crack")

	flag.Usage = func() {
		fmt.Printf("Usage:\n  %s -w <wordlist> -h <hash>\n", filepath.Base(os.Args[0]))
		fmt.Println("\nExample:")
		fmt.Println("  go run main.go -w nord_vpn.txt -h 485f5c36c6f8474f53a3b0e3613.................")
	}
