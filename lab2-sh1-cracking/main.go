...
func main() {
	...
	hashValue := flag.String("h", "aa1c7d931cf140bb35a5a16adeb83a551649c3b9", "Target SHA1 hash to crack")

	flag.Usage = func() {
		fmt.Printf("Usage:\n  %s -w <wordlist> -h <hash>\n", filepath.Base(os.Args[0]))
		fmt.Println("\nExample:")
		fmt.Println("  go run main.go -w nord_vpn.txt -h aa1c7d931cf140bb35a5a16adeb83a551649c3b9")
	}
